...
transcriptor.transcribe_dir(constants.manual_seg_dir, constants.audio_dir, constants.automatic_dir, constants.sample_rate, 'whisper')
transcriptor.transcribe_and_time_dir(constants.manual_seg_dir, constants.audio_dir, constants.automatic_dir, constants.sample_rate, 'whisper-tiny')
