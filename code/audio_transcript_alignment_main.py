...
def write_words_to_file(words, destination_file) :
    words = [word['transcript'] + '|' + word['start'] + '|'+ word['end'] + '|' + word['score'] for word in words]
    words = '\n'.join(words)
...
def read_words_from_file(file_path) :
    ...
    words = [ { 'transcript' : transcript, 'start' : start, 'end' : end, 'score' : score } for transcript, start, end, score in words ]
    return words
