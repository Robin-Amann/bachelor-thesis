...
def transcript_alignment(manual_dir, automatic_dir, hesitation_dir=None, only_around_hesitations = False, min_len=1) :
    if hesitation_dir :
        ...
        if only_around_hesitations :
            ...
            for index, word in enumerate(manual) :
                if word['word'] and (word['pause_type'] or word['is_restart']) :
                    ...
                    end = min(index + radius + 1, upper_bound)
